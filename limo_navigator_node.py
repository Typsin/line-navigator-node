...
def waypoint_client1():
   ...
   # Move -0.1 meters forward along the y axis of the "map" coordinate frame 
    goal1.target_pose.pose.position.x = 0.78
...
def waypoint_client2():
    ...
    goal2.target_pose.pose.position.y = 0.575
    # LIMO faces back
...
def waypoint_client3():
    ...
    goal3.target_pose.pose.position.x = 1.75
    goal3.target_pose.pose.position.y = 0.55
...
def waypoint_client4():
    ...
    goal4.target_pose.pose.position.x = 1.75
    goal4.target_pose.pose.position.y = -0.5
    # LIMO faces right
